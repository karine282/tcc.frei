...
import fotoEsporte from '../../assets/tenis.png';
import descFoto from '../../assets/voleiesporte.png';
import ClubeJoerg from '../../assets/clube.png';
...
export default function Esporte() {
    ...
    const handleSubmit = (e) => {
        ...
        // Exemplo futuro:
        // fetch(`https://sua-api.com/busca?q=${pesquisa}`)
        //   .then(res => res.json())
        //   .then(data => {
    ...
    return (
        <>
            ...
            <section className="hero esporte-hero" style={{ backgroundImage: `url(${fotoEsporte})` }}>
                <h1>Esportes</h1>
            </section>
            ...
            <section className="desc-esporte">
                ...
                <img src={descFoto} alt="Descrição esporte" className="fotoEsporte" />
            </section>
            ...
            <section className="areaClubes">
                ...
                <div className="containerClubes">
                    <div className="esquerdaClube">
                        <img src={ClubeJoerg} alt="Clube Joerg Bruder" className="clubeImagemGrande" />
                        <p>
